    ...
    <main class="mdl-layout__content">
        ...
        <div class="mdl-card__supporting-text color--dark-gray">
            <div class="mdl-grid">
                ...
                <form action="registerdokter_controller.php" method="POST">
                    <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <input class="mdl-textfield__input" type="text" id="name" name="nama" required>
                            <label class="mdl-textfield__label" for="nama">Nama Lengkap</label>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <input class="mdl-textfield__input" type="text" id="nip" name="nip" required>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <input class="mdl-textfield__input" type="text" id="alamat" name="alamat" required>
                            <label class="mdl-textfield__label" for="alamat">ALAMAT</label>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <input class="mdl-textfield__input" type="text" id="no_hp" name="no_hp" required>
                            <label class="mdl-textfield__label" for="nip">NOMOR HP</label>
                        </div>
                    </div>
                    <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                        <div class="mdl-layout-spacer"></div>
                            <button type="submit" value="Register"s class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-light-blue">
                                Sign Up
                            </button>  
                    </div>
                </form>

                            ...
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone form__article">
                                    <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="namaobat" name="nama_obat">
                                        <label class="mdl-textfield__label" for="nama">NAMA OBAT</label>
                                    </div>
                                    <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="kemasan_obat" name="kemasan">
                                        <label class="mdl-textfield__label" for="alamat">KEMASAN</label>
                                    </div>
                                    <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="harga_obat" name="harga">

        ...
        <div class="mdl-grid ui-tables">
            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    ...
                    <div class="mdl-card__title">
                        <a href="index.php?hal=pasien_create">
                        ...
                        <table class="mdl-data-table mdl-js-data-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="mdl-data-table__cell--non-numeric">NOMOR NM</th>
                                    ...
                                    <td>
                                            <li class="mdl-list__item">
                                                ...
                                                <form action="pasien_controller.php" method="POST">
                                                    <button value="hapus" name="proses" onclick="return confirm ('Apakah anda yakin ingin hapus data?')" title="Hapus pasien"  class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-red">

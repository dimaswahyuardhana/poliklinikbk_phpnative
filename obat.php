        ...
        <div class="mdl-grid ui-tables">
            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    ...
                    <div class="mdl-card__title">
                        <a href="index.php?hal=obat_create">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <li class="mdl-list__item">
                                                <a href="index.php?hal=obat_detail&id=<?= $row['id'] ?>">
                                                    <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-teal">
                                                        <i class="material-icons">visibility</i>
                                                    </button>
                                                </a>
                                                <a href="index.php?hal=obat_edit&id_edit=<?= $row['id'] ?>">
                                                    <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-orange">
                                                        <i class="material-icons">edit</i>
                                                    </button>
                                                </a>
                                                <form action="obat_controller.php" method="POST">
                                                <button value="hapus" name="proses" onclick="return confirm ('Apakah anda yakin ingin hapus data?')" title="Hapus obat"  class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-red">
